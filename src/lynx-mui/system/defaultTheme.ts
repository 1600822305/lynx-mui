...
export const defaultTheme: Theme = {
  ...
  // Full 25-entry MUI elevation scale (index 0..24), so Paper/Card/Dialog map 1:1.
  shadows: [
    'none',
  ...
  // MUI default zIndex scale (styles/zIndex.js), verbatim.
  zIndex: {
    mobileStepper: 1000,
    fab: 1050,
    speedDial: 1050,
  ...
  // MUI default transitions (styles/createTransitions.js), verbatim. Durations in ms.
  transitions: {
    duration: {
      shortest: 150,
      shorter: 200,
